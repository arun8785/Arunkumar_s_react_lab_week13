...
const ExpenseTracker = () => {
  ...
  const getPayable = () => {
    ...
    return {
      ...
      message:
        rahulPaid < rameshPaid ? "Rahul has to pay" : "Ramesh has to pay",
    };
  };
          ...
          <Form>
            <Form.Group className="mb-3" controlId="payeeName">
              ...
              >
                ...
                <option value="Rahul">Ashu</option>
        ...
        <tbody>
          {
            ...
            items.map((item) => (
              <tr key={item.id}>
                <td
                  className={
                    item.payeeName === "Rahul" ? "bg-success" : "bg-info"
                  }
                >
                  {item.payeeName}
                </td>
                <td>{item.setDate}</td>
                <td>{item.product}</td>
                <td className="text-end font-monospace">{item.price}</td>
              </tr>
            ))
          }
        </tbody>
